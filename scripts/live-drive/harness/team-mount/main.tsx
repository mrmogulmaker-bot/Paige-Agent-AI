...
// Both genuine themes are renderable: `?theme=light` must produce a real light surface, not a
// slightly-less-dark one. The harness sets every switch the app itself sets.
