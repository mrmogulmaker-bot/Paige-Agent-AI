...
const gatewayTools:Record<string,Array<Record<string,unknown>>>={
 'harness-tool-1':[
  ...
  {tool_name:'reschedule',app:'Scheduling',action_type:'calendar.move',effects:['update'],observed_at:'2026-09-20T10:00:00Z',approved:true,approved_at:'2026-09-10T11:00:00Z',expires_at:'2026-10-10T11:00:00Z',approval_expired:false,approval_stale:true,approved_by_you:false,approval_blocked_reason:null},
