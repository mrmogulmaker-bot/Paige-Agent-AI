...
export function PaigeSymbol(props:PaigeSymbolProps) {
  ...
  if(territory==="command") return <span className={`paige-symbol ${className}`} data-territory={territory} data-state={state} data-size={size} data-treatment={treatment} data-theme={theme} data-animated={animated} {...accessibility}><PaigeMark className="paige-symbol-command" animated={false} label={null}/></span>;
