...
export function TaskManager({ businessMode = false }: TaskManagerProps) {
  ...
  const framework = businessMode ? "BUILD" : "ACCEL";
  const frameworkTitle = businessMode ? "Business Credit" : "Personal Credit";
  const frameworkDesc = businessMode 
    ? "Business formation, business credit building, and funding tasks"
    : "Personal credit repair and improvement tasks";
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button
            onClick={businessMode ? generateBuildTasks : generateAccelTasks}
            variant="outline"
          ...
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Create New {frameworkTitle} Task</DialogTitle>
                <DialogDescription>
                  Add a task to track your {businessMode ? "business credit" : "personal credit repair"} progress
                </DialogDescription>
              </DialogHeader>
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder={businessMode ? "File for EIN" : "Pull credit reports"}
                  />
                </div>
                <div>
                ...
                <div>
                  <Label htmlFor="track">Framework Step</Label>
                  <Select
                    value={newTask.track}
                    onValueChange={(value) => setNewTask({ ...newTask, track: value })}
                  >
                    <SelectTrigger>
                      <SelectValue placeholder="Select framework step" />
                    </SelectTrigger>
                    <SelectContent>
                      {businessMode ? (
                        <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card className="shadow-card">
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <span className="text-3xl font-bold text-destructive">{overdueTasks.length}</span>
        ...
        <Card className="shadow-card">
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <span className="text-3xl font-bold text-success">{completedTasks.length}</span>
