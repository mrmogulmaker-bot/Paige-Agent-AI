...
interface BusinessBankAccountsOverviewProps {
  onNavigate: () => void;
}

export const BusinessBankAccountsOverview = ({ onNavigate }: BusinessBankAccountsOverviewProps) => {
  ...
  const fetchBankAccounts = async () => {
    try {
      ...
      console.error("Error fetching business bank accounts:", error);
      setLoading(false);
    }
  };
    ...
    >
      ...
      <div className="relative">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-2xl font-bold">Business Banking</h2>
            <p className="text-sm text-muted-foreground mt-1">Business Accounts</p>
          </div>
          ...
          <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Business connections</p>
              </div>
            </div>
