...
interface BusinessTasksOverviewProps {
  onNavigate: () => void;
}

export const BusinessTasksOverview = ({ onNavigate }: BusinessTasksOverviewProps) => {
    ...
    >
      ...
      <div className="relative">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-2xl font-bold">Business Tasks</h2>
