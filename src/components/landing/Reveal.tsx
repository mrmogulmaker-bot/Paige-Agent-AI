...
/**
 * Reveal — fades + lifts its children into view as they scroll on screen, so
 * the page phases in section by section going down. Honors
 * prefers-reduced-motion (renders immediately, no transform). One-shot: once
