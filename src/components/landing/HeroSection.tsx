        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                size="lg"
                className="bg-gradient-primary text-primary-foreground hover:opacity-90 shadow-glow transition-all duration-300"
            ...
            <Card className="p-6 bg-card border-border shadow-lg relative overflow-hidden">
              ...
              <div className="relative space-y-6">
                ...
                <div className="space-y-4">
                  <Card className="p-4 bg-gradient-to-r from-primary to-primary-light text-primary-foreground shadow-glow animate-fade-in">
                    <div className="flex items-center justify-between">
                      <div>
                  ...
                  <Card className="p-4 bg-gradient-accent text-accent-foreground shadow-glow-lg animate-fade-in" style={{ animationDelay: "0.1s" }}>
                    <div className="flex items-center justify-between">
                      <div>
                  ...
                  <Card className="p-4 bg-gradient-to-r from-success to-success-light text-white shadow-md animate-fade-in" style={{ animationDelay: "0.2s" }}>
                    <div className="flex items-center justify-between">
                      <div>
