...
function PipelineSurface({ data, setDetail }) {
  ...
  // refuses the turn if the caller may not read that client. Offered only when the
  // client is visible to this caller — `clientId` is null otherwise.
