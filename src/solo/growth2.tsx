...
function PipelineSurface({ data, setDetail }) {
  ...
  React.useEffect(()=>{pendingSelectionRef.current=null;setView("board");setMoving(null);setMovePicker(null);setKeyboardMove(null);setNotice("");setNewPipeline({name:"",description:"",stages:[]});},[data.tenantId]);
