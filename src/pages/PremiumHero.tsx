...
/**
 * PremiumHero — a hand-built, Framer-Motion animated hero for Paige.
 * No marketplace component: floating glow orbs, a masked tech grid, and a
 * staggered blur-to-sharp entrance, all in the brand purple. Route: /premium.
 */
...
export default function PremiumHero() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#0a0510] text-white flex items-center justify-center px-6">
      {/* Floating glow orbs */}
      <motion.div
        aria-hidden
      ...
      >
        ...
        <motion.div
          variants={item}
          className="mt-8 flex items-center gap-8 border-t border-white/10 pt-8"
        >
          {STATS.map(([n, l]) => (
