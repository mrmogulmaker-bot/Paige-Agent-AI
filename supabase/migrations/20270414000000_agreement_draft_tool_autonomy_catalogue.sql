-- Carry the COMPLETE autonomy catalogue forward, plus `agreement_draft`.
--
...
--
-- VISIBILITY ONLY. This grants no autonomy. `agreement_draft` is classified `ordinary`, and with
-- no stored row it reads `confirm` / `is_default = true` like every other unconfigured control —
-- so Paige still asks before she drafts.
