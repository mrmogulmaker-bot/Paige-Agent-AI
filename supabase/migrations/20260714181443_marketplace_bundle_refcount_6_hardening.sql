-- =============================================================================
-- RECONSTRUCTED from prod ledger — version 20260714181443 (marketplace_bundle_refcount_6_hardening)
-- =============================================================================
-- This file is the SQL recorded in
-- supabase_migrations.schema_migrations.statements for version 20260714181443 on prod
...
-- Wave 1 hardening (compliance follow-ups #2 + #3): REVOKE on finance-re helper;
-- tenant predicate in teardown child fetch (§9 self-defending).
