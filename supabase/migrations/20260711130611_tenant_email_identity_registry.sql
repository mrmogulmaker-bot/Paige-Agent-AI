-- =============================================================================
-- RECONSTRUCTED from prod ledger — version 20260711130611 (tenant_email_identity_registry)
-- =============================================================================
-- This file is the SQL recorded in
-- supabase_migrations.schema_migrations.statements for version 20260711130611 on prod
...
-- ── 5. Provision automatically on tenant creation ───────────────────────────────
...
-- ── 8. Re-point the three legacy resolvers at the canonical one ──────────────────
...
BEGIN
  ...
  PERFORM public.provision_tenant_email_identity(_tenant);
...
BEGIN
  ...
  IF p_from_name IS NOT NULL THEN
    v_from := NULLIF(TRIM(regexp_replace(p_from_name, '[[:cntrl:]]', ' ', 'g')), '');
