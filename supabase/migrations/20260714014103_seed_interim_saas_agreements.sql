...
-- ADJUSTMENT (drift audit 2026-07-14, not in the live ledger statement): make the seed
-- idempotent so a rebuild doesn't error on the existing rows. Unique key is (slug, version).
