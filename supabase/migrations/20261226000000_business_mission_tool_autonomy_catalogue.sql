-- Business Mission Phase 2: keep governed Mission record changes visible in the existing
-- Trust Compass autonomy catalogue. This is not a second approval system. The function body
-- below preserves the complete latest catalogue from 20261224000000 and adds exactly three
-- Planning entries for the three high-risk Mission mutations.
