-- =============================================================================
-- RECONSTRUCTED from prod ledger — version 20260709224426 (accept_tenant_invite_consumer)
-- =============================================================================
-- This file is the SQL recorded in
-- supabase_migrations.schema_migrations.statements for version 20260709224426 on prod
    ...
    ELSE
      ...
      IF _client_id IS NOT NULL THEN
        UPDATE public.clients
         ...
         WHERE id = _client_id;
      ELSE
        INSERT INTO public.clients (tenant_id, created_by, email, linked_user_id, onboarding_stage, status)
        VALUES (_tok.tenant_id, COALESCE(_tok.created_by, _tenant_owner, _uid), _email, _uid, 'invited', 'active')
