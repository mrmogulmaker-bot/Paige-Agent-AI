-- =============================================================================
-- RECONSTRUCTED from prod ledger — version 20260709230052 (tenant_invite_contact_binding)
-- =============================================================================
-- This file is the SQL recorded in
-- supabase_migrations.schema_migrations.statements for version 20260709230052 on prod
...
-- Bind the consumer-invite token to a contact_id + email at mint, accept the
-- bound contact, and refuse any cross-tenant client move (§9 seam).
