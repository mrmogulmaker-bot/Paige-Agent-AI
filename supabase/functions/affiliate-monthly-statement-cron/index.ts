        ...
        await supabase.functions.invoke("send-transactional-email", {
          body: {
            ...
            templateData: {
              ...
              referralUrl: `https://paigeagent.ai?ref=${aff.referral_code}`,
              clicks: clicks ?? 0,
              signups: signupsCount,
              conversions: conversionsCount,
              commissionEarned: fmtCents(commissionEarnedCents),
              commissionPaid: fmtCents(commissionPaidCents),
              pendingBalance: fmtCents(pendingCents),
