...
//
//   • DRAFT, VOID and STATUS register here — each is a clean `public.*` RPC that already exists.
...
export const AGREEMENT_CAPABILITIES = [AGREEMENT_DRAFT, AGREEMENT_VOID, AGREEMENT_STATUS] as const;
