...
export const CONTACT_IMPORT_LIST = {
 ...
 outcome: { kinds: ["verified","refused","pending","unknown"], projector: "public.list_contact_imports", railVisibility: "Tenant workspace events persist source, actor and committed outcomes." },
...
export const CONTACT_IMPORT_COMMIT = {
 ...
 outcome: { kinds: ["verified","refused","pending","unknown"], projector: "public.commit_contact_import_batch", railVisibility: "Tenant workspace events persist source, actor and committed outcomes." },
 chatBinding: "LIVE", mindBinding: "PARTIAL", maturity: "PARTIAL", sharedPrimitiveChange: "SCR-SOLO-ORCHESTRATION",
} as const satisfies SpineCapability;
export const SOLO_ORCHESTRATOR_LIST = {
 ...
 outcome: { kinds: ["verified","refused","pending","unknown"], projector: "public.solo_orchestration_service", railVisibility: "Tenant workspace events persist source, actor and committed outcomes." },
 chatBinding: "LIVE", mindBinding: "PARTIAL", maturity: "PARTIAL", sharedPrimitiveChange: "SCR-SOLO-ORCHESTRATION",
} as const satisfies SpineCapability;
