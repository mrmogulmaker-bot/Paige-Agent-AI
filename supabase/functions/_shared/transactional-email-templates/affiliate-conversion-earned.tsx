...
const amountValue = { fontSize: '44px', fontWeight: '800' as const, color: '#CFAE70', margin: '0', lineHeight: '1.1' }
...
const button = { backgroundColor: '#CFAE70', color: '#0a1628', padding: '14px 36px', borderRadius: '6px', fontSize: '16px', fontWeight: '700' as const, textDecoration: 'none', display: 'block' as const, textAlign: 'center' as const, margin: '8px auto 0', maxWidth: '240px' }
