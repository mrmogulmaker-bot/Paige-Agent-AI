...
const brandLabel = { color: '#EBB94C', fontSize: '12px', fontWeight: 700, letterSpacing: '2px', margin: '0 0 18px', textTransform: 'uppercase' as const }
...
const subhead = { color: '#EBB94C', fontSize: '15px', margin: 0 }
...
const roleBox = { backgroundColor: '#FAF7F0', borderLeft: '3px solid #EBB94C', padding: '16px 20px', margin: '0 0 28px', borderRadius: '4px' }
...
const ctaButton = { backgroundColor: '#EBB94C', color: '#0B0F1A', display: 'inline-block', fontSize: '15px', fontWeight: 700, padding: '14px 28px', borderRadius: '6px', textDecoration: 'none' }
