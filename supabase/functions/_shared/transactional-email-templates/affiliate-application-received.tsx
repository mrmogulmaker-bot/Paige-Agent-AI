...
const infoBox = { margin: '20px 0 24px', padding: '18px 20px', backgroundColor: '#f9fafb', borderLeft: '3px solid #EBB94C', borderRadius: '4px' }
...
const button = { backgroundColor: '#EBB94C', color: '#0a1628', padding: '14px 36px', borderRadius: '6px', fontSize: '15px', fontWeight: '700' as const, textDecoration: 'none', display: 'block' as const, textAlign: 'center' as const, margin: '24px auto 8px', maxWidth: '240px' }
