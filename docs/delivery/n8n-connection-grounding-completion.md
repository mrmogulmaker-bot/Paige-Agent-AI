...
- Independent review of OAuth diagnostic, registry and Chat confirms fixed-field output and existing protected-evidence/finaltenant gate coverage. N8n evidence now latches buffering for tenant turns; streaming may begin later because protected data waits for final scope validation.
