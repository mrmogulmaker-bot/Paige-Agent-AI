...
| Durable tasking (task↔thread link) | `tasks.source_thread_id` soft link (migration `20260811120000`) | **PARTIAL** | `tasks` + action bus | no chat tool proven to set it e2e; deep‑link UI is §00/CD |
