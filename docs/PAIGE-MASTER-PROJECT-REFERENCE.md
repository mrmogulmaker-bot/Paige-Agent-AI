...
| Registered Spine capabilities | **37** (2026-09-14, code-verified post-E7-merge; 35 across 12 modules at the af249ef grounding, +2 `calendar_link` — 13 domain modules; was 1 on 2026-09-02 — all `maturity: PARTIAL`; only `pipeline.deal_stage_evidence` in the Mind envelope contract) | `scripts/ci/paige-spine-registry-lint.mjs` · `docs/architecture/mind-memory-knowledge-brain-capability-map.md` |
...
registry now holds **37** capabilities (2026-09-14; +2 `calendar_link` merged), all `maturity: PARTIAL` — the "one registered capability" below
...
this was the plan on 2026-09-02; the registry has since grown to **37** capabilities (2026-09-14, code-verified; +2 `calendar_link`), all still
...
**The Spine is `PARTIAL`. 37 registered capabilities (2026-09-14, code-verified post-E7-merge; 35 at the af249ef grounding, +2 `calendar_link`; all `maturity: PARTIAL`),
105 inline Chat tools.** _(The "1 capability" measurement below is the 2026-09-02 snapshot; the registry
has since grown to 37 — see `docs/architecture/mind-memory-knowledge-brain-capability-map.md`. Nothing is
...
## 10. §13 corrections log
 ...
 - **2026-09-13 — Mind · Memory · Tenant Knowledge · Second-Brain vertical re-grounded; a consolidated
   ...
   2026-09-05) — it holds **37 capabilities, all `maturity: PARTIAL`, code-verified** (2026-09-14, +2 `calendar_link`; `registry.ts:21`,
   13 domain modules). Still true and NOT changed: only **one** of the 37 (`pipeline.deal_stage_evidence`)
