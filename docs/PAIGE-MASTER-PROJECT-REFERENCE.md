...
|---|---|---|
| Dedicated Paige workspace/chat and session/context behavior | `PARTIAL` | The tenant-aware workspace, persistent threads, account-switch fences, and transcript ownership exist. Context assembly remains distributed. **Chat-scroll P0 awaiting acceptance:** after owner-reported failures, #1080 removes the reproduced redundant portal move and is deployed. Indefinite manual ownership has passing controlled evidence; authenticated production acceptance remains PROOF OWED. Other workstreams continue undisturbed. |
...
the corrective evidence. #1075 reached production as `f86b1c401c492c4d0dc122258b6c26b96870befe`, but the owner reported the reset persisted. #1080 now removes the reproduced same-parent portal reinsertion and is deployed as `42a8d5aa760877fc34316ab3712523f86f95b19e`; authenticated acceptance of this correction is PROOF OWED, not resolved. The prior FAIL remains historical evidence. Other agents continue undisturbed.
...
| 2026-09-08 16:03 EDT | [#1075](https://github.com/mrmogulmaker-bot/Paige-Agent-AI/pull/1075) / `f86b1c401c492c4d0dc122258b6c26b96870befe` | **Delayed scroll intent correction.** Removed expiring input recognition and guarded stale callbacks/focus while preserving anchors. | **Deployed but owner acceptance FAIL.** READY deployment `dpl_63jHR5ys6w9h5NVQUJk7D2eiS9w7` served this build. Tests/review passed, but the owner subsequently reproduced top resets. #1080 addresses the separately reproduced ancestor portal reinsertion. Authority: [forensic record](evidence/ui-delivery/paige-chat-scroll-forensic-regression-correction.md). | **No.** Internal hotfix, not accepted as full resolution. |
| 2026-09-08 18:11 EDT | [#1080](https://github.com/mrmogulmaker-bot/Paige-Agent-AI/pull/1080) / `42a8d5aa760877fc34316ab3712523f86f95b19e` | **Chat portal top-reset correction.** Skips appendChild when the existing chat host is already in its target container; actual pop-out/redock relocation remains. No timer, threshold, fallback controller or redesign. | **Deployed; authenticated acceptance PROOF OWED.** READY deployment `dpl_7V1rPr1apLDUVujH9uZiWc3ZLH7y`; both domains serve `42a8d5aa760877fc34316ab3712523f86f95b19e-mtt84zjl`. Fresh independent exact-head review and CI pass;144 affected tests,4051 full tests and127 rendered checks pass. Real-component failing-first reproduction reset all five viewports to zero before the guard. Only affected product mount file: `src/components/tenant-shell/TenantCommandCenterShell.tsx`. Authority and indefinite preservation contract: [forensic closeout](evidence/ui-delivery/paige-chat-scroll-forensic-regression-correction.md). Next gate: signed-in owner acceptance; settled minimize evidence is not every-frame proof. | **No.** Internal production patch; no customer publication or full-resolution claim. |
