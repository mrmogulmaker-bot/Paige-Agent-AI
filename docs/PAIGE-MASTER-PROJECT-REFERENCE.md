...
the corrective evidence. Other agents continue undisturbed. #1075 is now merged and deployed as
`f86b1c401c492c4d0dc122258b6c26b96870befe`; authenticated owner acceptance remains PROOF OWED.
...
| 2026-09-08 16:03 EDT | [#1075](https://github.com/mrmogulmaker-bot/Paige-Agent-AI/pull/1075) / `f86b1c401c492c4d0dc122258b6c26b96870befe` | **Delayed owner-position theft correction.** Removed expiring input recognition, cancelled stale restoration and native smooth motion, captured native movement before layout writes, rejected programmatic focus ownership, and preserved existing semantic anchors and hidden geometry protections. No mount or neighboring feature change. | **Merged and deployed; owner acceptance PROOF OWED.** Exact-head CI and independent review pass;113affected and4026full tests pass. READY deployment `dpl_63jHR5ys6w9h5NVQUJk7D2eiS9w7` serves exact build `f86b1c401c492c4d0dc122258b6c26b96870befe-mtt3l0yt` on both production domains.117settled-endpoint browser checks pass; one earlier transient-animation comparison and its narrower settled proof boundary are preserved in the [canonical forensic closeout](evidence/ui-delivery/paige-chat-scroll-forensic-regression-correction.md). Signed-in browser tooling is unavailable; the owner must accept the formerly failing production flow before closure. | **No.** Internal hotfix only; no approved customer announcement. |
