...
(function () {
  ...
  P.PEOPLE = [
    { id:'p1', kind:'Company', name:'AUTHORIZED TENANT \u00b7 0f3a', sub:'Standalone \u00b7 12 seats', life:'Client',
      ...
      business:[['Entity type','LLC'],['Formation state','\u2014'],['EIN','47-2910883',1],['Tax classification','\u2014']],
    ...
    { id:'p2', kind:'Person', name:'fixture B', sub:'Owner \u00b7 AUTHORIZED TENANT 0f3a', life:'Client contact',
      ...
      business:[['Role','Owner'],['Company','AUTHORIZED TENANT 0f3a'],['SSN','412-88-0396',1]],
    ...
    { id:'p4', kind:'Company', name:'AUTHORIZED TENANT \u00b7 agency', sub:'Agency \u00b7 parent of 4', life:'Client',
      ...
      business:[['Entity type','\u2014'],['Formation state','\u2014'],['EIN','83-4416027',1],['Tax classification','\u2014']],
  ...
  P.ENTITIES = [
    { id: 'hold', name: 'AUTHORIZED TENANT \u00b7 holding', kind: 'Holding company', depth: 0,
      note: 'Signs for everything below it', ein: '83-4416027', state: 'Active', signer: 'You' },
    { id: 'ops', name: 'AUTHORIZED TENANT \u00b7 operations', kind: 'Operating entity', depth: 1,
      note: 'Where the work happens \u00b7 most seats live here', ein: '47-2910883', state: 'Active', signer: 'TEAM MEMBER \u00b7 exec' },
