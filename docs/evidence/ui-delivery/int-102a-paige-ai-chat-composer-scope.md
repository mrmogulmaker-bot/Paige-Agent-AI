...
RELEASE_TRUTH_BOUNDARY: PARTIAL / PROOF OWED: local state transitions, component behavior, mutations, static gates, and unchanged visual source are proven; authenticated deployed behavior is not
