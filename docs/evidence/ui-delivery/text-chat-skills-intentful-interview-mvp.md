...
INTERNAL_BUILD_IDENTITY: f88f78a869e78c58ac2fa686cfda7bb65aed142c; deployment=NOT_APPLICABLE; environment=development; migrations=PROOF_OWED(local replay unavailable and no remote migration authorized); edge=PROOF_OWED(paige-ai-chat change is not deployed and no edge deployment authorized); evidence=docs/evidence/ui-delivery/text-chat-skills-intentful-interview-mvp.md and PR 1044 checks
SUPPORTING_EVIDENCE_HEAD: 011e9d81bfa8977fa55637eb71d833eb2572fb7c; role=render artifacts, check record, and review-resolution evidence; subsequent commits may update metadata pointers only
