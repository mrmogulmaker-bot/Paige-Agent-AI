...
INTERNAL_BUILD_IDENTITY: code=8969ec637edabc33bd75eb0bf881cc56cbfcd8c1; deployment=PROOF_OWED; environment=development; migrations=NOT_APPLICABLE; edge=PROOF_OWED(paige-live-session-and-paige-live-relay-after-merge); evidence=scripts/paige-live-relay-smoke.mts
...
The third exact-head review found Hold/resume could unmute while the surface showed unavailable, and a replacement transport could forget the owner's mute choice. Code commit `8969ec637edabc33bd75eb0bf881cc56cbfcd8c1` preserves both with failing-first checks and keeps listening controls reachable after a ready relay is interrupted. This is still local fake-relay proof, not authenticated audio proof.
