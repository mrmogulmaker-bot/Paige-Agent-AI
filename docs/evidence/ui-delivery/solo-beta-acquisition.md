...
INTERNAL_BUILD_IDENTITY: eff296e0d5bceb49f352c0d2a50c522bf801f66c; deployment=NOT_DEPLOYED; environment=local; migrations=VERIFIED(fresh_replay_and_solo_pgtap_on_243ceb8163e1687fe8ea34e65175ee52d8b17d50)/PROOF_OWED(incremental_non_production_catalog); edge=PROOF_OWED(no_approved_non-production_provider_deployment); evidence=docs/evidence/ui-delivery/solo-beta-acquisition.md
...
Initial base: `299c39b2bc6c10eb0440ce415a626fb0d534f5ca` from fresh `origin/main` on 2026-09-12. Final reconciliation base: `373ffde27d463181eb5eed7393c202176cf3b8d2`, which contains PR #1159's replay bridge at `b17599cd`; the branch was rebased after that concrete merge and again after PR #1163, preserving both additive Master/Brain histories. The production build was verified on code head `eff296e0d5bceb49f352c0d2a50c522bf801f66c`; the fresh migration replay and both Solo pgTAP contracts were verified by GitHub run `34722573541` on implementation head `243ceb8163e1687fe8ea34e65175ee52d8b17d50`.
...
- **PR #1148 database-contract — VERIFIED on the implementation head:** current main contains PR #1159's narrow replay bridge (`b17599cd`), and this branch is rebased onto containing main head `373ffde27d463181eb5eed7393c202176cf3b8d2`. The repository check now explicitly executes both Solo pgTAP files after a zero-state replay; local Docker remains unavailable and is not claimed.
