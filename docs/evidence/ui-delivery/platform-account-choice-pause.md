...
AUTOMATED_EVIDENCE: PASS: 105/105 focused tests and 3,953/3,953 repository tests across account selection, switch guarding, operator targets, canonical landing resolution, workspace entry/exit, and the real chooser component
