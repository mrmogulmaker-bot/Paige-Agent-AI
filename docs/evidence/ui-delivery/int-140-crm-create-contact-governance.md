...
STATE_COVERAGE: PASS: covered states are canonical payload, production-shaped legacy name plus lifecycle alias, explicit canonical names, malformed unknown fields that remain fail closed, stable approval fingerprint, confirm proposal contract, standing-authority execution contract, canonical readback, receipt/Rail locator, tenant-scope guards, and account-change refusal
