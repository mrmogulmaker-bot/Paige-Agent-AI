...
| `canonical-solo-tenant-contract.md` | Exact-main Solo template inventory, all-active-tenant alignment snapshot, named Campaigns/Pipeline baseline evidence, delivery classes, reusable classifier, privacy rules, and release proof contract | Any Solo route, surface, bootstrap, tenant-state, parity, or alignment work |
