...
| `docs/prototypes/platform-billing-gate1.html` | Throwaway Gate 1 prototype — 27 billing states, boundary diagram, operator config flow; no network beyond fonts, no mutation | Gate 1 review of Billing only; delete or absorb after approval |
